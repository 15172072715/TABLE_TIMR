...
#define  COLLECTJIANGE          30//10

#define SHT2x_I2C_PORT          GPIOC
#define SHT2x_SCL_PIN           GPIO_Pin_11
#define SHT2x_SDA_PIN           GPIO_Pin_12
...
extern long Get_TempHumi(unsigned char *outbuff);
...
void TempHumi_Alarm_Process(void);
void collectTempHumi(void);
